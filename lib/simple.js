...
export function smsg(conn, m, hasParent) {
 ...
 export function serialize() {
    ...
    // Validación de existencia antes de modificar el prototipo
    if (!proto ||!proto.WebMessageInfo ||!proto.WebMessageInfo.prototype) {
        console.error('❌ proto.WebMessageInfo.prototype no está disponible. No se puede serializar.');
        return;
}
    ...
    Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        // Puedes seguir agregando más propiedades aquí si lo necesitas
});
}
        },
        isBaileys: {
